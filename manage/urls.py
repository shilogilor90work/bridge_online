...
urlpatterns = [
    ...
    path('hand_list/<int:limit>/', views.hand_list_limit, name='hand_list'),
    path('hand_list_no_shuffle/', views.hand_list_no_shuffle, name='hand_list'),
    path('hand_list_no_answer_only/', views.hand_list_no_answer_only, name='hand_list'),
    path('hand_list_no_shuffle/<int:limit>/', views.hand_list_no_shuffle_limit, name='hand_list'),
    path('hand_list_no_shuffle/<int:start_point>/<int:end_point>/', views.hand_list_no_shuffle_limit_and_start, name='hand_list'),
